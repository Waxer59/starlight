...
Consulta las [instrucciones de configuración manual](/manual-setup/) para agregar Starlight a un proyecto Astro existente.
...
Cuando trabajas localmente, el servidor de desarrollo de Astro te permite previsualizar tu trabajo y actualiza automáticamente tu navegador cuando realizas cambios. Puedes obtener más información en [la referencia de la interfaz de línea de comandos de Astro](https://docs.astro.build/es/reference/cli-reference/#astro-dev).
